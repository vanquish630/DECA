...
cfg.model.eye_face_indices_path = os.path.join(cfg.deca_dir, 'data', 'eye_face_indices.npy')
...
cfg.model.mean_tex_path = os.path.join(cfg.deca_dir, 'data', 'mean_texture_HR_mod.png')
